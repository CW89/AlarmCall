...
public class MapActivity extends FragmentActivity {
	...
	private View.OnClickListener onNameSearch = new View.OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			final LinearLayout linear = (LinearLayout) View.inflate(MapActivity.this, R.layout.dialog_map_namesearch, null);
			...
			new AlertDialog.Builder(MapActivity.this).setTitle("명칭을 입력하세요")
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			if (nameEt.getText().length() > 0) {
				...
				progressDialog = ProgressDialog.show(
						MapActivity.this, "Wait", "검색 중입니다");
	
				httpUtil.requestMapSearch(new ResultHandler(MapActivity.this), nameEt.getText().toString(), addrTv.getText().toString());
	...
	static class ResultHandler extends Handler {
		...
		ResultHandler(MapActivity activity) {
